...
CREATE TABLE `tickets` (
  ...
  `attributed_to` int(11) DEFAULT NULL,
  ...
  `UnidadeOrg` varchar(255) DEFAULT NULL,
  `attributed_to_name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2024-04-09 14:35:44
